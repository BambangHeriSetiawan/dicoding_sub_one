...
public class MovieFavoriteWidget extends AppWidgetProvider {
  public static final String TOAST_ACTION = "com.simxdeveloper.catalogmovie.TOAST_ACTION";
  public static final String EXTRA_ITEM = "com.simxdeveloper.catalogmovie.EXTRA_ITEM";

  static void updateAppWidget (Context context, AppWidgetManager appWidgetManager, int appWidgetId) {

    Intent intent = new Intent(context, MoviesStackWidgetService.class);
