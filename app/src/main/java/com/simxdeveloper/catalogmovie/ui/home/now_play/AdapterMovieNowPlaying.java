 ...
 */
public class AdapterMovieNowPlaying extends Adapter<Holder> {

  private NowPlayingPresenter presenter;
  private List<ResultsItem> resultsItems;

  public AdapterMovieNowPlaying (NowPlayingPresenter presenter,
  ...
  public void onBindViewHolder (@NonNull Holder holder, int position) {
    ...
    Glide.with (Apps.getContext ()).load (Const.IMAGE_PATH + resultsItem.getPosterPath ())
